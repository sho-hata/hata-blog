  ...
  return (
    <div class={"px-6 mt-6"}>
      <section class="py-12 bg-slate-50 rounded-lg shadow-md markdown px-8">
        ...
        <h2>経歴</h2>
        <p>
          2020年に株式会社エイチームに新卒入社し、バックエンド・WebフロントエンドでのWebメディアサービスの開発を担当。</p>
          <p>2022年より、株式会社カンムでAndroid/iOS・バックエンドでのToC向け投資・クレジットカードサービスの開発を担当。2025年より、同社で toB 資金調達サービスの新規事業のエンジニアとして開発に従事。
        </p>
